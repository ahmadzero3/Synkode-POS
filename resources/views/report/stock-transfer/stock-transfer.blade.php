@extends('layouts.app')
@section('title', __('warehouse.stock_transfer_report'))
        ...
        <div class="page-wrapper">
            <div class="page-content">
                <x-breadcrumb :langArray="[
                                            ...
                                            'warehouse.stock_transfer_report',
                                        ]"/>
                <div class="row">
                    <form class="row g-3 needs-validation" id="reportForm" action="{{ route('report.stock_transfer.ajax') }}" enctype="multipart/form-data">
                        {{-- CSRF Protection --}}
                        @csrf
                        @method('POST')
                        ...
                        <div class="col-12 col-lg-12">
                            <div class="card">
                                <div class="card-header px-4 py-3">
                                    <h5 class="mb-0">{{ __('warehouse.stock_transfer_report') }}</h5>
                                </div>
...
@section('js')
    ...
    <script src="{{ versionedAsset('custom/js/reports/stock-transfer/stock-transfer.js') }}"></script>
