...
@section('title', __('expense.report'))
        ...
        <div class="page-wrapper">
            <div class="page-content">
                ...
                <div class="row">
                    <form class="row g-3 needs-validation" id="reportForm" action="{{ route('report.expense.ajax') }}" enctype="multipart/form-data">
                        {{-- CSRF Protection --}}
                        @csrf
                        @method('POST')
                        ...
                        <div class="col-12 col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body p-4 row g-3">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <x-label for="expense_category_id" name="{{ __('expense.category.category') }}" />
...
@section('js')
    ...
    <script src="{{ versionedAsset('custom/js/reports/expense/expense.js') }}"></script>
