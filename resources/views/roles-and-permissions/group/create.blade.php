@extends('layouts.app')
@section('title', __('app.create_group'))
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <!-- 🔹 Added w-100 so the card takes full page width -->
                    <div class="card w-100">
                        <div class="card-header px-4 py-3">
                            <h5 class="mb-0">{{ __('app.general') }}</h5>
                        </div>
                        <div class="card-body p-4">
                            <form class="row g-3 needs-validation" id="groupForm"
                                action="{{ route('permission.store.group') }}" enctype="multipart/form-data">
                                {{-- CSRF Protection --}}
                                @csrf
                                @method('POST')
