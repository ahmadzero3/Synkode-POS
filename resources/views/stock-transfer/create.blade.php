...
@section('content')
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="row">
                <form class="g-3 needs-validation" id="stockTransferForm" action="{{ route('stock_transfer.store') }}"
                                ...
                                <div class="card-body p-4 row g-3">
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group mb-3">
                                            <x-input type="text" additionalClasses="datepicker" name="transfer_date"
                                                :required="true" value="" />
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <x-dropdown-warehouse selected="" dropdownName='to_warehouse_id'
                                            :enableToSelect="true" />
                                    </div>
                                    <div class="col-md-4">
                                ...
                                <div class="card-body p-4 row g-3">
                                    ...
                                    <div class="col-md-12 table-responsive">
                                        <table class="table mb-0 table-striped table-bordered" id="stockTransferItemsTable">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td colspan="12" class="text-center fw-light fst-italic default-row">
